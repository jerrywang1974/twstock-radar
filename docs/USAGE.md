...
```bash
# 依某日法人資料，請 AI 多提一些可實作規則構想
twstock-radar rule-ideas --date 2026-09-11

# 不呼叫模型，只載入內建範本
twstock-radar rule-ideas --date 2026-09-11 --no-ai
```

或在 UI「規則」頁按 **AI 產生構想**。這些構想**不會自動啟用**，只供你參考後再決定要不要實作。
